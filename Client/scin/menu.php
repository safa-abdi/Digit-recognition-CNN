	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	...
	        	<li class="nav-item active"><a href="menu.php" class="nav-link">Mission</a></li>
	        	<li class="nav-item"><a href="commander.php" class="nav-link">Panier</a></li>
            ...
            <form action='comm.php' method='post'>
					...
					<p name='p' value=$row[idB]></p>
						...
						<td align='center' >
								...
								<br>
								<br>
									<button type='submit'class='btn btn-warning'>Plus de détails</button><br>
									<input type='hidden' name='c' value=$row[idB]>
								</td>
								</div>
			    	</td>
				</form>
