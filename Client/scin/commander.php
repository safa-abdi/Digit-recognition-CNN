...
<html lang="en">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light ftco-navbar-light-2" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">SCIN</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	...
	        	<li class="nav-item "><a href="menu.php" class="nav-link">Mission</a></li>
	        	<li class="nav-item active"><a href="commander.php" class="nav-link">Panier</a></li>
  ...
  <div class="heading-section ftco-animate mb-5">
                <span class="subheading" align='center'>Panier</span>
                <img src='img\images.png' align='right'>
              </div>
      </div>
...
foreach($resu as $row){
echo "
            <form action='suppP.php' method='post'>
					<tr><td>
					<img src='img/$row[imgPB]' name='a' width='350px' height='300px'>
					</td>
						<td align='center' >
								<div class='one-half'>
                <h5>Nom Piece:$row[NomPB]</h5><br>
                <h5>Quantité:$row[qte]</h5>
                <h5>Référence:$row[reference]</h5>
								<br>
								<br>
                    <button type='submit'class='btn btn-danger'>Supprimer</button><br>
                    <input type='hidden' name='d' value=$row[idC]>
								</td>
                </div>
			    	</td>
				</form>
      ...
      ?>
      <tr><td> <button type='submit'class='btn btn-warning'>Commander</button><br></td></tr>
	</table>
	</section>
